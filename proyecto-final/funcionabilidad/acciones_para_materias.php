...
class materias{
	...
	public function agregar_materia($nombre, $curso, $carrera){
	    $consulta_insertar_materia = "INSERT INTO materia (nombre, curso, carrera)
	...
	public function modificar_materia($id, $nombre, $curso, $carrera){
	    $consulta_modificar_materia = "UPDATE materia SET nombre = '$nombre',curso='$curso',carrera='$carrera'
                WHERE id= '$id';";
	...
	public function listar_materias(){
		$consulta_listar_materias = "SELECT * FROM materia;";
	...
	public function listar_materia_por_id($id){
		$consulta_listar_materias = "SELECT * FROM materia WHERE id = '$id';";
        $consulta=$this->db->query($consulta_listar_materias);
        return $consulta->fetch_assoc();
    }

    public function listar_materias_acotada(){
    	$consulta_listar_materias = "SELECT id, nombre FROM materia;";
        $consulta=$this->db->query($consulta_listar_materias);
        while($filas=$consulta->fetch_assoc()){
            $this->materias[]=$filas;
        }
